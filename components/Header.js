...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morningnews-backend-wine.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnews-backend-wine.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	const remontrer =()=>{
console.log('remontrer' , hiddenArticles)
